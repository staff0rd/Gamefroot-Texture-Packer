...
exports.generateImage = function (files, options, callback) {
	...
	// This is used to help avoid E2BIG errors, if we were really fancy we could auto-detect
	// this from the environment. Larger numbers = better performance, but less safe.
	// Ideally you want to use about half the maximum system allowance, to be on the safe side.
