...
exports.determineCanvasSize = function (files, options, callback) {
	...
	options.groups.forEach(function(group){
		applySquareAndPowerConstraints(group, options.square, options.powerOfTwo);
	});
...
exports.generateImage = function (files, options, callback) {
	...
	files.forEach(function (file) {
		command.push('"' + file.path + '" -geometry +' + (file.x + options.padding + options.gutter) + '+' + (file.y + options.padding + options.gutter) + ' -composite');
	});
